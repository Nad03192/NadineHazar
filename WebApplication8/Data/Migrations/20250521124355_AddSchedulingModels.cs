...
{
    /// <inheritdoc />
    public partial class AddSchedulingModels : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoadedTimeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoadedTimes", x => x.LoadedTimeId);
                    table.ForeignKey(
                        name: "FK_LoadedTimes_AspNetUsers_UserId",
                        column: x => x.UserId,
